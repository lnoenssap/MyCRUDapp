sap.ui.define([
	...
	return BaseObject.extend("com.sap.mycrudapp.MyCRUDApp.model.GroupSortState", {
		 ...
		 * @class
		 * @public
		 * @alias com.sap.mycrudapp.MyCRUDApp.model.GroupSortState
		 */
		...
		/**
		 * Sorts by CompanyName, or by SupplierID
		 *
		...
		/**
		 * Groups by SupplierID, or resets the grouping for the key "None"
		 *
		 * @param sKey - the key of the field used for grouping
		 * @returns {sap.ui.model.Sorter[]} an array of sorters
		 */
		group: function (sKey) {
			...
			if (sKey === "SupplierID") {
				...
				this._oViewModel.setProperty("/sortBy", "SupplierID");

				aSorters.push(
					new Sorter("SupplierID", false,
