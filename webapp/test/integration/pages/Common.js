sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("com/sap/mycrudapp/MyCRUDApp/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#MyCRUDApp-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#MyCRUDApp-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("com.sap.mycrudapp.MyCRUDApp.test.integration.pages.Common", {
		...
		getMockServer: function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/sap/mycrudapp/MyCRUDApp/localService/mockserver"], function (mockserver) {
