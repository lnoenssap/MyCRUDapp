sap.ui.define([
	...
	opaTest("MasterList Filtering on SupplierID less than 100", function (Given, When, Then) {

		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
		and.iSelectListItemInViewSettingsDialog("SupplierID").
		and.iSelectListItemInViewSettingsDialog("<100 Phone").
	...
	opaTest("MasterList Filtering on SupplierID more than 100", function (Given, When, Then) {
		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
		and.iSelectListItemInViewSettingsDialog(">100 Phone").
		and.iPressOKInViewSelectionDialog();
