sap.ui.define([
	...
	function createResourceModel() {
		return new ResourceModel({
			bundleUrl: [$.sap.getModulePath("com.sap.mycrudapp.MyCRUDApp"), "i18n/i18n.properties"].join("/")
		});
	}
	...
	QUnit.test("Should group a price lesser equal 20", function (assert) {
		...
		// System under test
		var fnGroup = Grouper.SupplierID(this._oResourceModel.getResourceBundle());
