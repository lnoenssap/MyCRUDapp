/*global history */
sap.ui.define([
	"com/sap/mycrudapp/MyCRUDApp/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"sap/ui/model/Filter",
	"sap/ui/model/FilterOperator",
	"sap/m/GroupHeaderListItem",
	"sap/ui/Device",
	"com/sap/mycrudapp/MyCRUDApp/model/formatter",
	"sap/m/MessageBox",
	"com/sap/mycrudapp/MyCRUDApp/model/grouper",
	"com/sap/mycrudapp/MyCRUDApp/model/GroupSortState"
], function (BaseController, JSONModel, Filter, FilterOperator, GroupHeaderListItem, Device, formatter, MessageBox, grouper,
	GroupSortState) {
	"use strict";

	return BaseController.extend("com.sap.mycrudapp.MyCRUDApp.controller.Master", {
		...
		onOpenViewSettings: function () {
			if (!this._oViewSettingsDialog) {
				this._oViewSettingsDialog = sap.ui.xmlfragment("com.sap.mycrudapp.MyCRUDApp.view.ViewSettingsDialog", this);
		...
		onConfirmViewSettingsDialog: function (oEvent) {
			...
			aFilterItems.forEach(function (oItem) {
				switch (oItem.getKey()) {
				case "Filter1":
					aFilters.push(new Filter("SupplierID", FilterOperator.LE, 100));
					break;
				case "Filter2":
					aFilters.push(new Filter("SupplierID", FilterOperator.GT, 100));
					break;
				default:
					break;
				}
